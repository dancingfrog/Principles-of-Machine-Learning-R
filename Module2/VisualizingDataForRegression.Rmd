...
numcols <- c('price', 'city.mpg', 'curb.weight', 'engine.size', 'fuel.type', 'horsepower')
...
plot_ggp <- ggpairs(auto_prices,
      ...
      lower = list(continuous = wrap("points", alpha = 0.3), combo = wrap("dot_no_facet", binwidth = 1)),
      upper = list(continuous = ggally_density, combo = wrap("dot_no_facet", binwidth = 1)),
      progress = FALSE)
```

```{r render, echo=FALSE, fig.width=14, fig.height=14, warning=FALSE}
print(plot_ggp)
```
